...
#   c) node1 mines 32 blocks, so now node 0 has 60001kyd, node 1 has 4250kyd, node2 has none.
#   d) node0 sends 601 kyd to node2, in two transactions (301 kyd, then 300 kyd).
