...
COIN_TGZ='https://github.com/kydcoin/KYD3/releases/download/3.3.1/kyd-3.3.1-ubuntu16.04-x86-64.tar.gz'
fi
if [[ $(lsb_release -d) = *18.04* ]]; then
COIN_TGZ='https://github.com/kydcoin/KYD3/releases/download/3.3.1/kyd-3.3.1-ubuntu18.04-x86-64.tar.gz'
fi
...
bsdmainutils libdb4.8++-dev libminiupnpc-dev libgmp3-dev ufw fail2ban pkg-config libevent-dev libzmq5 libdb4.8-dev libdb4.8++-dev >/dev/null 2>&1
if [ "$?" -gt "0" ];
  then
...
libboost-program-options-dev libboost-system-dev libboost-test-dev libboost-thread-dev sudo automake git curl libdb4.8-dev \
bsdmainutils libdb4.8++-dev libminiupnpc-dev libgmp3-dev ufw fail2ban pkg-config libevent-dev libzmq5 libdb4.8-dev libdb4.8++-dev"
 exit 1
fi
