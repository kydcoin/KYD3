...
* Update translations see [translation_process.md](https://github.com/kyd-actual/kyd-coin/blob/master/doc/translation_process.md#synchronising-translations).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/kyd-actual/gitian.sigs.git
    git clone https://github.com/kyd-actual/kyd-detached-sigs.git
...
### Build and sign KYD Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit kyd=v${VERSION} ../kyd/contrib/gitian-descriptors/gitian-osx.yml
...
- Detached signatures will then be committed to the [kyd-detached-sigs](https://github.com/kyd-actual/kyd-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the kydcoin.io server*.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/kyd-actual/kyd-coin/releases/new) with a link to the archived release notes.
