...
`contrib/kyd-qt.pro` takes care of generating `.qm` (binary compiled) files from `.ts` (source files) files. It’s mostly automated, and you shouldn’t need to worry about it.
...
```
git add src/qt/kydstrings.cpp src/qt/locale/kyd_en.ts
git commit
```
...
1. Open `kyd_en.ts` in Qt Linguist (included in the Qt SDK)
...
<qresource prefix="/translations">
    <file alias="en">locale/kyd_en.qm</file>
    ...
</qresource>
```
