...
#ifndef KYD_ZKYDTRACKER_H
#define KYD_ZKYDTRACKER_H
...
public:
    CzKYDTracker(std::string strWalletFile);
    ~CzKYDTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzKYDWallet* zKYDWallet = NULL);
