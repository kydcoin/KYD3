                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzKYDPathCustom = GetArg("-zkydbackuppath", "");
    ...
    if(!strzKYDPathCustom.empty()) {
        ui->wallet_customzkydbackuppath->setText(QString::fromStdString(strzKYDPathCustom));
        ui->wallet_customzkydbackuppath_label->setVisible(true);
        ui->wallet_customzkydbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzKYDPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the KYD RPC console.") + "<br>" +
