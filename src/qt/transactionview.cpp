 ...
 */
    ...
    typeWidget->addItem(tr("Received KYD from zKYD"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zKYD"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zKyd));
