...
extern UniValue setzkydseed(const UniValue& params, bool fHelp);
extern UniValue getzkydseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzkyd(const UniValue& params, bool fHelp);
extern UniValue dzkydstate(const UniValue& params, bool fHelp);
