...
#ifndef KYD_ZKYDWALLET_H
#define KYD_ZKYDWALLET_H
...
public:
    CzKYDWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZKYD(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
