...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"kyd", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"kyd", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"kyd", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        ...
        {"kyd", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzkydseed", &getzkydseed, false, false, true},
        {"zerocoin", "setzkydseed", &setzkydseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzkyd", &searchdzkyd, false, false, true},
        {"zerocoin", "dzkydstate", &dzkydstate, false, false, true}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9333/\n";
}
